...
Original file is located at
    https://colab.research.google.com/drive/1U60b2fMvHK77aLb-e7NPO_hoQK_aD7LI

教學網站
https://notes.andywu.tw/2019/用tensorflowkeras訓練辨識驗證碼的cnn模型/
"""
...
img_filenames = os.listdir('/content/drive/MyDrive/timg')

for img_filename in img_filenames:
    if '.jpg' not in img_filename:
        continue
    img = load_img('/content/drive/MyDrive/timg/{0}'.format(img_filename), color_mode='grayscale')
